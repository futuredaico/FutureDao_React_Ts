...
import { IMolochoInfoProps, IProjectTeam, IProjReward, IProjReserveList } from '../interface/MolochoInfo.interface';
...
@observer
class MolochoRightTeam extends React.Component<IMolochoInfoProps, IState> {
...
export default injectIntl(MolochoRightTeam);
