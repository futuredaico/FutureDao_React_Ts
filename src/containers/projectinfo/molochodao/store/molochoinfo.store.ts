...
import { IMolochoInfo, IProjectTeam, IDiscussList, IDiscussReplyList, IProjAssetPrice, IProjReward, IProjReserveToken, IContractHash } from '../interface/MolochoInfo.interface';
...
class MolochoInfo
{
  ...
  @observable public projInfo: IMolochoInfo | null = null; // 项目详情
...
export default new MolochoInfo();