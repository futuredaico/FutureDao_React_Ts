...
class TopInfoV1 extends React.Component<IProjectInfoProps> {
                ...
                <div className="topright-wrapper">
                    ...
                    <div className="other-wrapper">
                        ...
                        <div className="tips-content">
                            <span className="gray-content">该项目仅展示了创意，暂未发布合约</span>
                        </div>
    ...
    // 关注
    private handleToAttention = async () =>
    {
        let res = false;
        ...
        {
            res = await this.props.projectinfo.cancelAttention();
        } else
        {
            res = await this.props.projectinfo.startAttention();
        }
        if(res){
