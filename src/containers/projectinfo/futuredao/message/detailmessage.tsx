...
@observer
class DetailMessage extends React.Component<IProjectInfoProps, IState> {
    ...
    public render()
    {
        ...
        return (
            <div className="message-wrapper" id="message">
                ...
                {/* this.props.projectinfo.projInfo.discussCount  */}
                {
                    this.props.projectinfo.projDiscussList.length !== 0 && (
                                ...
                                this.props.projectinfo.projDiscussList.map((item: IDiscussList, index: number) =>
                                {
                                    return (
                                        <div className="comment-list" key={index}>
                                            ...
                                            {
                                                (item.isShowReply && this.props.projectinfo.projInfo) && (
                                                            ...
                                                            item.childredList.map((replyItem: IDiscussReplyList, num: number) =>
                                                            {
                                                                return (
                                                                    <div className="reply-list" key={num}>
                                                                        ...
                                                                        {
                                                                            (replyItem.isShowReply && this.props.projectinfo.projInfo) && (
