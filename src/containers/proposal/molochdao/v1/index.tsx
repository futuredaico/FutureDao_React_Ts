...
class MolochProposal extends React.Component<IMolochProposalProps, IState> {
    ...
    private handleSendProposal = async () => {
        ...
        await this.props.index.applyProposal(contractHash, assetHash, this.state.tianAddress, fiveNum, requireNum, JSON.stringify(tianStr), this.props.common.userInfo.address, (txid: string) => {
            if (txid) {
