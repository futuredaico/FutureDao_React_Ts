            ...
            if (this.props.projectinfo.projInfo )
            {
                ...
                if (this.props.metamaskwallet.metamaskAddress)
                {
                    ...
                    try
                    {
                        ...
                        const txid = await this.props.transation.buy(this.props.metamaskwallet.metamaskAddress,this.state.minBuyCount,this.props.order.orderInfo.totalCost,this.props.order.orderInfo.orderId,this.props.order.hash)     
                        console.log(txid);
                        if(!!txid){
